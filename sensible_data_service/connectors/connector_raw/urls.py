...
urlpatterns = patterns('connectors.connector_raw',
	...
	url(r'^v1/cell/','raw_data.cell'),
	url(r'^v1/sms/','raw_data.sms'),
	url(r'^v1/experience_sampling/', 'raw_data.experience_sampling'),
	url(r'^v1/epidemic/', 'raw_data.epidemic'),
	url(r'^v1/screen/', 'raw_data.screen'),
	url(r'^v1/activity/', 'raw_data.activity'),
	...
	url(r'^v1/grades/', 'raw_data.grades'),
