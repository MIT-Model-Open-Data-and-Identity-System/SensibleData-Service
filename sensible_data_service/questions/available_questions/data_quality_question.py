...
def get_data_stats_for_period(request, user, scopes, users_to_return, user_roles, own_data):
	...
	month_stats = db_helper.execute_named_query({"database": quality_named_query["database"], "query": formatted_query}, tuple(params), readonly=False)
