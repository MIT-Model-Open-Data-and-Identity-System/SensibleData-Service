	...
	"get_device_inventory_with_device_id": {
     ...
     "get_new_scan_chunk_main": {
      ...
      "get_user_seen_in_time_main": {
		"query": "SELECT user_seen, time, timestamp FROM main WHERE user = %s AND timestamp > %s AND timestamp < %s",
		"database": "question_who_did_i_see"
      }, 
      ...
      "insert_who_did_i_see_main": {
		"query": "INSERT INTO main (user, user_seen, timestamp, time) VALUES (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE time = time + %s",
		"database": "question_who_did_i_see"        
      },
      
      "insert_who_did_i_see_developer": {
		"query": "INSERT INTO developer (user, user_seen, timestamp, time) VALUES (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE time = time + %s",
		"database": "question_who_did_i_see"        
      },
      
      "insert_who_did_i_see_researcher": {
		"query": "INSERT INTO researcher (user, user_seen, timestamp, time) VALUES (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE time = time + %s",
		"database": "question_who_did_i_see"        
      },
      
      #update
      "update_last_scan_id": {
		"query": "UPDATE last_scan_id SET id %s WHERE table_name = %s",
		"database": "question_who_did_i_see"
	},
