...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Authorization.activated_at'
        db.add_column(u'authorization_manager_authorization', 'activated_at',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Authorization.created_at'
        db.alter_column(u'authorization_manager_authorization', 'created_at', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Authorization.activated_at'
        db.delete_column(u'authorization_manager_authorization', 'activated_at')


        # Changing field 'Authorization.created_at'
        db.alter_column(u'authorization_manager_authorization', 'created_at', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    models = {
        u'application_manager.application': {
            'Meta': {'object_name': 'Application'},
            '_id': ('django.db.models.fields.CharField', [], {'default': "'2e288872fe1a4f55d863'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        u'authorization_manager.authorization': {
            ...
            'created_at': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371473118'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nonce': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'oauth2app.accesstoken': {
            ...
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371476718'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371473118'}),
            'mac_key': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'null': 'True', 'default': "'aea471d154'", 'max_length': '10', 'blank': 'True', 'unique': 'True', 'db_index': 'True'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'58c89f36fc'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oauth2app.client': {
            'Meta': {'object_name': 'Client'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'c00aab90ea5f7714563184353c4ff6'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'87ee2f93cc61a76a49d9ab3655ff1c'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
