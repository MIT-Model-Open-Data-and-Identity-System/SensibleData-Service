...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client.api_uri'
        db.delete_column(u'oauth2app_client', 'api_uri')


    def backwards(self, orm):
        # Adding field 'Client.api_uri'
        db.add_column(u'oauth2app_client', 'api_uri',
    ...
    models = {
        ...
        u'oauth2app.accesstoken': {
            ...
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371408006'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371404406'}),
            'mac_key': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'null': 'True', 'default': "'162a0a97e7'", 'max_length': '10', 'blank': 'True', 'unique': 'True', 'db_index': 'True'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2d387ea587'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'829d220f20185e9fd03f0621d514bf'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'c12f8109a11ef46a39683ba480f3ff'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oauth2app.code': {
            'Meta': {'object_name': 'Code'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oauth2app.Client']"}),
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371404526'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1371404406'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'2d6ecbe4c5a3a6670472b49208aaea'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'scope': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['connectors.Scope']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
