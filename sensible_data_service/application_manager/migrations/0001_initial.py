...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'application_manager_application', (
            ...
            ('_id', self.gf('django.db.models.fields.CharField')(default='2ff6dab3d665d5947f3d', unique=True, max_length=20, db_index=True)),
        ...
        db.create_table(u'application_manager_gcmregistration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('device_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
    ...
    models = {
        u'application_manager.application': {
            ...
            '_id': ('django.db.models.fields.CharField', [], {'default': "'640183b0dd875473bca8'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'769953dca517f87b3442040d15c842'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'b419f55155f82ba9079ab3c1724055'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
