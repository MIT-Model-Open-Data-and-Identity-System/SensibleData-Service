...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GcmRegistration.device_id'
        db.delete_column(u'application_manager_gcmregistration', 'device_id_id')

        # Adding field 'GcmRegistration.device'
        db.add_column(u'application_manager_gcmregistration', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['application_manager.Device']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GcmRegistration.device_id'
        db.add_column(u'application_manager_gcmregistration', 'device_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['application_manager.Device']),
                      keep_default=False)

        # Deleting field 'GcmRegistration.device'
        db.delete_column(u'application_manager_gcmregistration', 'device_id')


    models = {
        u'application_manager.application': {
            'Meta': {'object_name': 'Application'},
            '_id': ('django.db.models.fields.CharField', [], {'default': "'35f85ee111205fd73909'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'c5965a34f7f7582f8e64c4fe682fad'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'2b8551b70e66a647ccfc7e65571810'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
