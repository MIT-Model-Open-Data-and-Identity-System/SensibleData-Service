...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.extra_params'
        db.add_column(u'application_manager_application', 'extra_params',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.extra_params'
        db.delete_column(u'application_manager_application', 'extra_params')


    models = {
        u'application_manager.application': {
            'Meta': {'object_name': 'Application'},
            '_id': ('django.db.models.fields.CharField', [], {'default': "'9112416c2355609f8409'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
            ...
            'extra_params': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'grant_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'06d00a685f62df5232bfa53b277ff7'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'205416e1c71f7a02041fc90a9b2c19'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
