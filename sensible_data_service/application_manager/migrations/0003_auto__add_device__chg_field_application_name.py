...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'application_manager_application', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Application.name'
        db.alter_column(u'application_manager_application', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))

    models = {
        u'application_manager.application': {
            'Meta': {'object_name': 'Application'},
            '_id': ('django.db.models.fields.CharField', [], {'default': "'61d3aba69436723beec8'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'1392b5df74880f9de9a757527d9301'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'f1b04cb23765fb1974811b275526e9'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
