...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GcmRegistration.application'
        db.add_column(u'application_manager_gcmregistration', 'application',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['application_manager.Application'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GcmRegistration.application'
        db.delete_column(u'application_manager_gcmregistration', 'application_id')


    models = {
        u'application_manager.application': {
            'Meta': {'object_name': 'Application'},
            '_id': ('django.db.models.fields.CharField', [], {'default': "'4bdd856b6eb152c2e72f'", 'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        u'application_manager.gcmregistration': {
            ...
            'device_id': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'45df893d4dcbabcfeef9e55ead2f67'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'redirect_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'0b2867f663591a657b6e424412e66a'", 'unique': 'True', 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
